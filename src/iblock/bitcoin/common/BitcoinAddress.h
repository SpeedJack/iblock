...
class IBLOCK_API BitcoinAddress : public ::omnetpp::cObject
{
	...
	public:
		...
		BitcoinAddress(const Hash& address);
		...
		BitcoinAddress& operator=(const Hash& address) { return *this = BitcoinAddress(address); }
		...
		bool isSameWallet(const Hash& address) const { return isSameWallet(BitcoinAddress(address)); }
		...
		bool operator==(const Hash& address) const { return *this == BitcoinAddress(address); }
		bool operator!=(const Hash& address) const { return !operator==(address); }
